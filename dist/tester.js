      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 147:
            ...
            log('\nI wrote your app code to the `CHROMATIC_APP_CODE` environment variable.\n      \nIf you do not trust your code hosting provider, please remove it from `package.json` and set it when running builds (in particular on your CI server).', { noPrefix: true });
